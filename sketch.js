...
function setup()
{
    ...
    ram=createSprite((displayWidth-30)/2,(displayHeight-180),20,20);
...
button2.position((displayWidth/2)+200,(displayHeight/2)-40,150,150);
}
...
fire1=createSprite(displayWidth-1100/3,displayHeight-190,50,50);
